  ...
  <section class="merchant-flow">
    ...
    <template v-else>
      ...
      <!--
        ...
        **두 문단으로 끊는다** — 무엇을 보고 골랐나 / 적립은 어떻게 견주나 다.
        붙여 놓으면 한 덩어리로 보여서 적립 환산 기준이 앞 문장에 묻힌다.

        제외 기준을 설명하던 셋째 문단은 뺐다. 목록에 안 뜨는 카드를 설명하는 문단인데,
        백엔드가 `CONDITION_NOT_MET` · `NO_BENEFIT` 카드까지 내려주고 화면이 그대로
        보여주므로 "제외되었어요" 가 실제 목록과 어긋난다.
      -->
